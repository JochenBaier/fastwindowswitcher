...
namespace FastWindowSwitcherLib
{
  ...
  public:
    ...
    virtual QList<quintptr> GetBlackListetWindows(const std::vector<FastWindowSwitcherLib::MonitorInfo>& p_monitorInfos) = 0;
    ...
    virtual void UpdateElements(SelectableElementRepository& p_selectableElementRepository, const std::vector<MonitorInfo>& p_monitors, bool& p_updateNedded) = 0;
