...
namespace FastWindowSwitcherLib
{
  ...
  public:
    ...
    QList<quintptr> GetBlackListetWindows() override;
    ...
    void UpdateElements(SelectableElementRepository& p_selectableElementRepository, const QList<quintptr>& p_windowBlackList, const std::vector<MonitorInfo>& p_monitors, bool& p_updateNedded) override;
