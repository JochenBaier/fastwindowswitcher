...
namespace FastWindowSwitcherLib
{
  ...
  class SelectablePanelElement : public  SelectableElement
  {
  public:
    SelectablePanelElement(UIElementPtr p_element, QString  p_key_combination, QList<QRect> p_visible_text_positions, const int& p_monitor);
